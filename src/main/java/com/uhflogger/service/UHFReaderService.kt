...
//        // Add BT_MAX_RETRIES (3) * BT_RETRY_DELAY_MS (2s) on top as margin.
//        // 20s gives comfortable headroom above the ~12s connect() worst case.
//        // Worst case per startBtConnection: BT_MAX_RETRIES (3) attempts,
//        // each with a single connect() call (~12s timeout when out of range)
//        // plus BT_RETRY_DELAY_MS (2s) between retries.
//        // 3 × (12s + 2s) = 42s. Add margin → 50s.
//        private const val BT_ATTEMPT_SETTLE_MS     = 50000L
